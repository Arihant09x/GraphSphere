...
graphRoutes.get("/path", validate(pathSchema), graphController.path);
graphRoutes.get("/recommendations/:id", validate(idParamSchema), graphController.recommendations);
